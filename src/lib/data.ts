...
export const tapeheadsSubmissions: Report[] = [
  ...
  },
  {
    ...
    shift: 2,
    date: new Date('2023-10-26T16:45:00Z'),
    status: 'Submitted',
    shift_lead_name: "Lead B",
    th_number: "TH-4",
    material_type: "Carbon",
    order_entry: "OIT76541-101",
    end_of_shift_status: "Completed",
    shift_start_time: "14:00",
    shift_end_time: "22:00",
    total_meters: 1600,
  ...
  },
  {
    ...
    shift: 3,
    date: new Date('2023-10-26T00:30:00Z'),
    status: 'Submitted',
    shift_lead_name: "Lead C",
    th_number: "TH-5",
    material_type: "Polyester",
    order_entry: "OIT76541-111",
    end_of_shift_status: "Completed",
  ...
  },
  {
    ...
    operatorName: 'S. Davis',
    shift: 1,
    date: new Date('2023-10-28T08:30:00Z'),
    status: 'Approved',
    shift_lead_name: "Lead A",
    th_number: "TH-2",
    material_type: "Fiber",
    order_entry: "OAUS32145-001",
    end_of_shift_status: "Completed",
    shift_start_time: "06:00",
    shift_end_time: "14:00",
    total_meters: 1350,
  ...
  },
  {
    ...
    operatorName: 'B. Johnson',
    shift: 1,
    date: new Date('2023-10-28T08:00:00Z'),
    status: 'Approved',
    shift_lead_name: "Lead A",
    th_number: "TH-1",
    material_type: "Carbon",
    order_entry: "OAUS32145-101",
    end_of_shift_status: "Completed",
    shift_start_time: "06:00",
    shift_end_time: "14:00",
    total_meters: 1550,
    ...
    had_spin_out: false,
    checklist_items: { smooth_fuse_full: true, blades_glasses: true, spray_tracks_on_bridge: true, meter_stick: true },
    leadComments: 'Consistent performance.'
  },
];
